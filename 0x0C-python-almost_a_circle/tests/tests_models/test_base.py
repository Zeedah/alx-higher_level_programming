...
class TestBase_load_from_file_csv(unittest.TestCase):
    ...
    def test_load_from_file_csv_rectangle_types(self):
        ...
        self.assertTrue(all(type(obj) == Rectangle for obj in output))    def test_load_from_file_csv_first_square(self):
        s1 = Square(5, 1, 3, 3)
        s2 = Square(9, 5, 2, 3)
        Square.save_to_file_csv([s1, s2])
